...
func notifyIfNeeded(
	...
	subject := fmt.Sprintf("Theia Docker Image Security Update - %s", time.Now().Format("Mon-Jan-2"))

	// Craft email body.
	textBody := "This email is sent by the Antreabot as a result of a security scan on an Theia Docker image.\n"
	textBody += "\n"
