...
| grafana.installPlugins | list | `["https://github.com/yuntanghsu/grafana_sankey_plugin/archive/refs/tags/v1.0.1.zip;theia-grafana-sankey-plugin","https://github.com/yuntanghsu/grafana_chord_plugin/archive/refs/tags/v1.0.1.zip;theia-grafana-chord-plugin","https://downloads.antrea.io/artifacts/grafana-custom-plugins/theia-grafana-dependency-plugin-1.0.2.zip;theia-grafana-dependency-plugin","grafana-clickhouse-datasource 2.2.0"]` | Grafana plugins to install. |
