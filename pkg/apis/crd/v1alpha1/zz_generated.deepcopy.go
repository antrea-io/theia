...
func (in *NetworkPolicyRecommendationStatus) DeepCopyInto(out *NetworkPolicyRecommendationStatus) {
	*out = *in
	if in.RecommendedNP != nil {
		in, out := &in.RecommendedNP, &out.RecommendedNP
		*out = new(RecommendedNetworkPolicy)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecommendedNetworkPolicy) DeepCopyInto(out *RecommendedNetworkPolicy) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecommendedNetworkPolicy.
func (in *RecommendedNetworkPolicy) DeepCopy() *RecommendedNetworkPolicy {
	if in == nil {
		return nil
	}
	out := new(RecommendedNetworkPolicy)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RecommendedNetworkPolicy) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecommendedNetworkPolicyList) DeepCopyInto(out *RecommendedNetworkPolicyList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RecommendedNetworkPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecommendedNetworkPolicyList.
func (in *RecommendedNetworkPolicyList) DeepCopy() *RecommendedNetworkPolicyList {
	if in == nil {
		return nil
	}
	out := new(RecommendedNetworkPolicyList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RecommendedNetworkPolicyList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecommendedNetworkPolicySpec) DeepCopyInto(out *RecommendedNetworkPolicySpec) {
	*out = *in
	in.TimeCreated.DeepCopyInto(&out.TimeCreated)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecommendedNetworkPolicySpec.
func (in *RecommendedNetworkPolicySpec) DeepCopy() *RecommendedNetworkPolicySpec {
	if in == nil {
		return nil
	}
	out := new(RecommendedNetworkPolicySpec)
	in.DeepCopyInto(out)
	return out
}
